...
extern NSString * const DICE_REPORT_SHARED_DIRECTORY;
...
extern NSString * const DICE_TEMP_CACHE_PREFIX;
...
extern NSInteger const DICE_FEATURES_MAX_ZOOM;
extern NSInteger const DICE_FEATURE_TILES_MIN_ZOOM_OFFSET;
